...
new Login();
},{"./modules/containers/main.js":3,"./modules/searchRecipes/main.js":14,"./modules/user/models/user.js":28,"./modules/user/views/login.js":29,"./vendor/moment.js":30}],2:[function(require,module,exports){
...
},{"../models/container.js":4}],3:[function(require,module,exports){
...
},{"./collections/containers.js":2,"./views/containers.js":9,"./views/header.js":10,"./views/history.js":11}],4:[function(require,module,exports){
...
module.exports = '﻿<input id="new-container-name" name="container-name" />';
},{}],6:[function(require,module,exports){
module.exports = '﻿<header>\n' +
    '    <h4>\n' +
    '        <%= Name %>\n' +
    '        <button type="button" class="btn btn-link btn-xs btn-delete pull-right"><i class="glyphicon glyphicon-trash"></i></button>\n' +
    '    </h4>\n' +
    '</header>\n' +
    '<ul>\n' +
...
module.exports = '﻿<section>\n' +
    '    <header>\n' +
    '        <h4>\n' +
    '            <%= App.moment(Created).calendar() %>\n' +
    '            <span class="pull-right">Kr. <%= TotalPrice %></span>\n' +
    '        </h4>\n' +
    '    </header>\n' +
    '    <ul>\n' +
...
},{"../templates/container.html":6}],9:[function(require,module,exports){
...
},{"./container.js":8}],10:[function(require,module,exports){
...
},{"../templates/addContainerPopover.html":5}],11:[function(require,module,exports){
...
},{"../../user/collections/history.js":26,"../templates/history.html":7}],12:[function(require,module,exports){
...
},{"../models/recipe.js":15}],13:[function(require,module,exports){
module.exports = Backbone.Collection.extend({
...
},{"../models/superMarket.js":16}],14:[function(require,module,exports){
...
},{"./collections/recipes.js":12,"./views/cart.js":22,"./views/recipes.js":24,"./views/search.js":25}],15:[function(require,module,exports){
module.exports = Backbone.Model.extend({
...
module.exports = '﻿<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n' +
    '    <form role="form" class="modal-dialog modal-lg">\n' +
    ...
    '                    <div class="row">\n' +
    '                        <div class="col-lg-8 border-right-light">\n' +
    ...
    '                            <div class="row">\n' +
    '                                <div class="col-lg-3">\n' +
    '                                    <input type="text" class="form-control" id="PostCode" placeholder="Post code" required="required">\n' +
    '                                </div>\n' +
    '                                <div class="col-lg-9">\n' +
    '                                    <input type="text" class="form-control" id="PostAddress" placeholder="Post address" required="required">\n' +
    '                                </div>\n' +
    '                            </div>\n' +
    '\n' +
    '                            <hr />\n' +
    ...
    '                                <input type="text" class="form-control" id="CardHoldersName" required="required">\n' +
    '                            </div>\n' +
    '                            <div class="form-group">\n' +
    '                                <label for="CardNumber">Card number</label>\n' +
    '                                <input type="text" class="form-control" id="CardNumber" placeholder="XXXX XXXX XXXX XXXX" required="required">\n' +
    '                            </div>\n' +
    '                            <div class="row">\n' +
    '                                <div class="col-lg-2">\n' +
    '                                    <label for="ExpireDateMonth">Month</label>\n' +
    '                                    <input type="number" class="form-control" id="ExpireDateMonth" required="required">\n' +
    '                                </div>\n' +
    '                                <div class="col-lg-2">\n' +
    '                                    <label for="ExpireDateYear">Year</label>\n' +
    '                                    <input type="number" class="form-control" id="ExpireDateYear" required="required">\n' +
    '                                </div>\n' +
    '                                <div class="col-lg-2 col-lg-offset-6">\n' +
    '                                    <label for="CVCode">CV Code</label>\n' +
    '                                    <input type="number" class="form-control" id="CVCode" required="required">\n' +
    '                                </div>\n' +
    '                            </div>\n' +
    '                        </div>\n' +
    ...
    '                <button type="submit" class="btn btn-primary btn-place-order" data-loading-text="Loading...">Place order</button>\n' +
...
module.exports = '﻿<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n' +
    '    <form role="form" class="modal-dialog modal-sm">\n' +
    '        <div class="modal-content">\n' +
    '            <div class="modal-header">\n' +
    '                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>\n' +
    '                <h4 class="modal-title" id="myModalLabel">Checkout</h4>\n' +
...
module.exports = '﻿<div class="row">\n' +
    ...
    '                <li><i class="glyphicon glyphicon-star-empty"></i></li>\n' +
    '            </ul>\n' +
    '            <ul class="rating-actual rated-<%= rating %>">\n' +
    ...
    '\n' +
    '        <h3>Supermarkets</h3>\n' +
    '        <ul class="super-markets-list"></ul>\n' +
    '    </div>\n' +
    '</div>';
},{}],20:[function(require,module,exports){
module.exports = '﻿<li data-toggle="tooltip">\n' +
    '    <% if(MissingIngredients.length) { %>\n' +
    '    <button class="btn btn-link btn-xs btn-missing-ingredients" title="Missing ingredients" data-content="<%= MissingIngredients.join("<br />") %>"><i class="glyphicon glyphicon-warning-sign"></i></button> \n' +
    '    <% } %>\n' +
    '    <%= Name %> (Kr. <%= TotalPrice %>)\n' +
    '    <div class="btn-group-supermarket">\n' +
    '        <button class="btn btn-xs btn-link btn-show-map" data-toggle="modal" data-address="<%= Address %>"><i class="glyphicon glyphicon-map-marker"></i></button>\n' +
    '        <button class="btn btn-xs btn-link btn-add-to-cart" data-supermarket-id="<%= Id %>"><i class="glyphicon glyphicon-shopping-cart" data-alternate="glyphicon glyphicon-remove"></i></button>\n' +
    '    </div>\n' +
    '</li>';
...
module.exports = '﻿<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\n' +
    ...
    '            </div>\n' +
    '            <div class="modal-body modal-body-super-market-map">\n' +
    '                \n' +
    '            </div>\n' +
    '            <div class="modal-footer">\n' +
...
},{"../templates/checkoutModal.html":17,"../templates/checkoutSuccessModal.html":18}],23:[function(require,module,exports){
...
},{"../collections/superMarkets.js":13,"../templates/recipe.html":19,"../templates/superMarket.html":20,"../templates/superMarketMapModal.html":21}],24:[function(require,module,exports){
...
},{"./recipe.js":23}],25:[function(require,module,exports){
module.exports = Backbone.View.extend({
...
},{"../models/history.js":27}],27:[function(require,module,exports){
module.exports = Backbone.Model.extend({
